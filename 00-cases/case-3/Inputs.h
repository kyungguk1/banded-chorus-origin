...
// version: commit 029f3f104b9fcd56b6662eac2dabebf539412c6b
//
...
struct Input {
    ...
    static constexpr auto part_descs     = std::make_tuple(
            ...
            BiMaxPlasmaDesc({ { -1, 0.441588 * sqrt_twothirds, 3 }, 10000, _2nd, full_f }, 0.000624 * twothirds, 6.89062),
            PartialShellPlasmaDesc({ { -1, 0.316228 * sqrt_twothirds, 3 }, 10000, _2nd, full_f }, 0.0002 * twothirds, 0, 0.16));
