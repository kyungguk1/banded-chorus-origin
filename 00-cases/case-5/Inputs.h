...
// version: commit dafb14b35a8577164a96da53ca5fc5057ef83659
//
...
struct Input {
    ...
    ///
    static constexpr unsigned number_of_distributed_particle_subdomain_clones = 98 * 2;
    ...
    static constexpr auto part_descs     = std::make_tuple(
            LossconePlasmaDesc({ { -1, 0.387298 * sqrt_twothirds, 3 }, 10000, _2nd, full_f }, 0.01728 * twothirds, 1.6684027778, 0.3),
            BiMaxPlasmaDesc({ { -1, 0.474342 * sqrt_twothirds, 3 }, 10000, _2nd, full_f }, 0.00072 * twothirds, 6.89062),
            PartialShellPlasmaDesc({ { -1, 0.387298 * sqrt_twothirds, 3 }, 10000, _2nd, full_f }, 0.0000375 * twothirds, 0, 0.13));
    ...
    static constexpr std::array<std::pair<Range, unsigned>, std::tuple_size_v<decltype(part_descs)>>
        v1hist_specs = {
            ...
            std::make_pair(c *Range{ -1, 2 } / 3, 200),
        };
    static constexpr std::array<std::pair<Range, unsigned>, std::tuple_size_v<decltype(part_descs)>>
        v2hist_specs = {
            std::make_pair(c * Range{ +0, 1 } / 1, 100),
            std::make_pair(c *Range{ +0, 1 } / 2, 100),
            std::make_pair(c *Range{ +0, 1 } / 3, 100),
        };
};
