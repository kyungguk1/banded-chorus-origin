...
struct Input {
    ...
    /// time step size
    ///
    static constexpr Real dt = 0.0004;
    ...
    static constexpr auto part_descs
        = std::make_tuple(BiMaxPlasmaDesc({{1, 25, 2}, 10000, TSC, full_f}, 5, .1),
                          BiMaxPlasmaDesc({{-25, 125, 2}, 10000, TSC, full_f}, 0.5, 1));
