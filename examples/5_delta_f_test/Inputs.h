...
struct Input {
    ...
    ///
    static constexpr Real theta = 10;

    /// simulation grid size
    ///
    static constexpr Real Dx = 0.25;

    /// number of grid points
    ///
    static constexpr unsigned Nx = 512;
    ...
    /// simulation time t = dt*Nt
    ///
    static constexpr unsigned outer_Nt = 2000;
    ...
    static constexpr auto part_descs
        = std::make_tuple(BiMaxPlasmaDesc({{-1, 1.26491, 2}, 4000, TSC, delta_f}, 0.1, 2),
                          BiMaxPlasmaDesc({{-1, 3.79473, 2}, 200, TSC, full_f}, 0.0009, 1));
    ...
    ///
    static constexpr unsigned particle_recording_frequency = 400;
