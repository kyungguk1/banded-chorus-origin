...
auto RelativisticLossconeVDF::f0_comoving(const Vector &u0) const noexcept -> Real
{
...
auto RelativisticLossconeVDF::f0_lab(Vector const &u, Real const denom) const noexcept -> Real
{
