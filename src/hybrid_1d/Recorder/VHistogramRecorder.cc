...
decltype(auto) H1D::VHistogramRecorder::write_attr(Object &&obj, Domain const &domain,
                                                   long const step)
{
    obj << domain.params;
...
void H1D::VHistogramRecorder::write_data(hdf5::Group &root, global_vhist_t vhist)
{
...
void H1D::VHistogramRecorder::record_master(const Domain &domain, long step_count)
{
    // create hdf file
