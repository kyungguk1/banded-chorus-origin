...
private:
    ...
    auto histogram(PartSpecies const &sp, Indexer const &idxer, local_vhist_t (*)(PartSpecies const &, Indexer const &)) const
        -> global_vhist_t;
    ...
    [[nodiscard]] static auto velocity_local_counting(PartSpecies const &sp, Indexer const &idxer) -> local_vhist_t;
    [[nodiscard]] static auto momentum_local_counting(PartSpecies const &sp, Indexer const &idxer) -> local_vhist_t;
