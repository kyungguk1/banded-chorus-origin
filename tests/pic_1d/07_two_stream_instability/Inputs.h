...
struct Input {
    ...
    ///
    static constexpr bool should_neglect_transverse_component   = true;
    ...
    static constexpr auto part_descs = std::make_tuple(
        CounterBeamPlasmaDesc({ { -O0, 0.1, 3 }, 5000, _2nd, full_f }, 0.01, 0.42, 2));

    /// cold fluid plasma descriptors
    ///
    static constexpr auto cold_descs = std::make_tuple(
        ColdPlasmaDesc({ -O0, 0.9949874371 }));
    ...
    ///
    static constexpr std::pair<unsigned, Range> moment_recording_frequency = { 0, {} };
    ...
    ///
    static constexpr std::pair<unsigned, Range> particle_recording_frequency = { 0, {} };
    ...
    static constexpr std::array<std::pair<Range, unsigned>, std::tuple_size_v<decltype(part_descs)>>
        v1hist_specs = {
            std::make_pair(5.00 * Range{ -1, 2 }, 200),
        };
    static constexpr std::array<std::pair<Range, unsigned>, std::tuple_size_v<decltype(part_descs)>>
        v2hist_specs = {
            std::make_pair(2.00 * Range{ +0, 1 }, 80),
        };
