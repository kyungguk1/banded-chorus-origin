...
struct Input {
    ...
    static constexpr auto part_descs
        = std::make_tuple(BiMaxPlasmaDesc({ { -O0, c *O0 / M_SQRT2, 2 }, 500, TSC, full_f }, 0.01 / 2),
                          BiMaxPlasmaDesc({ { -O0, c *O0 / M_SQRT2, 2 }, 500, TSC, delta_f }, 0.01 / 2));
    ...
    ///
    static constexpr std::pair<unsigned, Range> particle_recording_frequency = { outer_Nt, {} };
    ...
    ///
    static constexpr std::pair<unsigned, Range> vhistogram_recording_frequency = { outer_Nt, {} };
    ...
    static constexpr std::array<std::pair<Range, unsigned>, std::tuple_size_v<decltype(part_descs)>>
        v1hist_specs = {
            std::make_pair(0.4 * Range{ -1, 2 }, 150),
            std::make_pair(0.4 * Range{ -1, 2 }, 150),
        };
    static constexpr std::array<std::pair<Range, unsigned>, std::tuple_size_v<decltype(part_descs)>>
        v2hist_specs = {
