...
struct Input {
    ...
    ///
    static constexpr auto mpOme       = 1836.0;
    static constexpr auto sqrt_mpOme  = 42.8485705712571;
    static constexpr auto beta_e      = 0.01;
    static constexpr auto efluid_desc = eFluidDesc({ -O0 * mpOme, c *sqrt_mpOme }, beta_e, adiabatic);

    /// kinetic plasma descriptors
    ///
    static constexpr auto part_descs = std::make_tuple(
        BiMaxPlasmaDesc({ { O0, c, 1 }, 500, _2nd, full_f, 0.0, 1 }, beta_e, 1));
    ...
    ///
    static constexpr std::pair<unsigned, Range> moment_recording_frequency = { 1, {} };
    ...
    ///
    static constexpr std::pair<unsigned, Range> particle_recording_frequency = {};
